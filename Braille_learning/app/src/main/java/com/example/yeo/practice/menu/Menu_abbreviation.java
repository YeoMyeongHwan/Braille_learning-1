...
public class Menu_abbreviation extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_abbreviation);

        finish = MediaPlayer.create(Menu_abbreviation.this, R.raw.basicfinish); // 기초과정의 종료를 알리는 음성파일
    }
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) { //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    ...
                    Menu_detail_contents.menu_page=11;
