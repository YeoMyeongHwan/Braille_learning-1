...
public class Quiz_Braille_writing_short_practice2 extends FragmentActivity{
    /*
    3칸 이하의 점자 쓰기퀴즈를 진행하는 클래스 두번째 버전
    */
    Quiz_Braille_writing_short_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Quiz_Braille_writing_short_display(this);
