...
public class Quiz_Braille_reading_short_practice extends FragmentActivity implements TextToSpeech.OnInitListener {
/*
3칸 이하의 점자 퀴즈를 진행하는 클래스
*/
    Quiz_Braille_reading_short_display m;
    ...
    com.example.yeo.practice.quiz.quiz_score quiz_score;
    static int score = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Quiz_Braille_reading_short_display(this);
