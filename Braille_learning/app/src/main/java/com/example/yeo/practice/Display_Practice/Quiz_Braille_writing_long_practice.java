...
import com.example.yeo.practice.Braille_data.dot_quiz_word;
import com.example.yeo.practice.MainActivity;
import com.example.yeo.practice.quiz.quiz_score;
import com.example.yeo.practice.quiz.quiz_service;
import com.example.yeo.practice.quiz.score_service;
...
public class Quiz_Braille_writing_long_practice extends FragmentActivity {
    Quiz_Braille_writing_long_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Quiz_Braille_writing_long_display(this);
    ...
    public void touch_insert_check(int coordinate_temp){
        ...
        if(coordinate_temp==1) { coordinate_x=0; coordinate_y=0;}
        else if(coordinate_temp==2) { coordinate_x=0; coordinate_y=1;}
        else if(coordinate_temp==3) { coordinate_x=0; coordinate_y=2;}
        else if(coordinate_temp==4) { coordinate_x=1; coordinate_y=0;}
        else if(coordinate_temp==5) { coordinate_x=1; coordinate_y=1;}
        else if(coordinate_temp==6) { coordinate_x=1; coordinate_y=2;}
        else if(coordinate_temp==7) { coordinate_x=2; coordinate_y=0;}
        else if(coordinate_temp==8) { coordinate_x=2; coordinate_y=1;}
        else if(coordinate_temp==9) { coordinate_x=2; coordinate_y=2;}
        else if(coordinate_temp==10) { coordinate_x=3; coordinate_y=0;}
        else if(coordinate_temp==11) { coordinate_x=3; coordinate_y=1;}
        else if(coordinate_temp==12) { coordinate_x=3; coordinate_y=2;}
        else if(coordinate_temp==13) { coordinate_x=4; coordinate_y=0;}
        else if(coordinate_temp==14) { coordinate_x=4; coordinate_y=1;}
        else if(coordinate_temp==15) { coordinate_x=4; coordinate_y=2;}
        else if(coordinate_temp==16) { coordinate_x=5; coordinate_y=0;}
        else if(coordinate_temp==17) { coordinate_x=5; coordinate_y=1;}
        else if(coordinate_temp==18) { coordinate_x=5; coordinate_y=2;}
        else if(coordinate_temp==19) { coordinate_x=6; coordinate_y=0;}
        else if(coordinate_temp==20) { coordinate_x=6; coordinate_y=1;}
        else if(coordinate_temp==21) { coordinate_x=6; coordinate_y=2;}
        else if(coordinate_temp==22) { coordinate_x=7; coordinate_y=0;}
        else if(coordinate_temp==23) { coordinate_x=7; coordinate_y=1;}
        else if(coordinate_temp==24) { coordinate_x=7; coordinate_y=2;}
        else if(coordinate_temp==25) { coordinate_x=8; coordinate_y=0;}
        else if(coordinate_temp==26) { coordinate_x=8; coordinate_y=1;}
        else if(coordinate_temp==27) { coordinate_x=8; coordinate_y=2;}
        else if(coordinate_temp==28) { coordinate_x=9; coordinate_y=0;}
        else if(coordinate_temp==29) { coordinate_x=9; coordinate_y=1;}
        else if(coordinate_temp==30) { coordinate_x=9; coordinate_y=2;}
        else if(coordinate_temp==31) { coordinate_x=10; coordinate_y=0;}
        else if(coordinate_temp==32) { coordinate_x=10; coordinate_y=1;}
        else if(coordinate_temp==33) { coordinate_x=10; coordinate_y=2;}
        else if(coordinate_temp==34) { coordinate_x=11; coordinate_y=0;}
        else if(coordinate_temp==35) { coordinate_x=11; coordinate_y=1;}
        else if(coordinate_temp==36) { coordinate_x=11; coordinate_y=2;}
        else if(coordinate_temp==37) { coordinate_x=12; coordinate_y=0;}
        else if(coordinate_temp==38) { coordinate_x=12; coordinate_y=1;}
        else if(coordinate_temp==39) { coordinate_x=12; coordinate_y=2;}
        else if(coordinate_temp==40) { coordinate_x=13; coordinate_y=0;}
        else if(coordinate_temp==41) { coordinate_x=13; coordinate_y=1;}
        else if(coordinate_temp==42) { coordinate_x=13; coordinate_y=2;}
