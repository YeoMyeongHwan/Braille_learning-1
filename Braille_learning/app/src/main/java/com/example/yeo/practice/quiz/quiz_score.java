...
import com.example.yeo.practice.menu.Menu_quiz_abbreviation;
import com.example.yeo.practice.menu.Menu_quiz_alphabet;
import com.example.yeo.practice.menu.Menu_quiz_final;
import com.example.yeo.practice.menu.Menu_quiz_initial;
import com.example.yeo.practice.menu.Menu_quiz_letter;
import com.example.yeo.practice.menu.Menu_quiz_number;
import com.example.yeo.practice.menu.Menu_quiz_sentence;
import com.example.yeo.practice.menu.Menu_quiz_vowel;
...
public class quiz_score extends AppCompatActivity {
    ...
    TextView tv_score;
    TextView comment;
    com.example.yeo.practice.menu.quiz_menu_service quiz_menu_service;
    com.example.yeo.practice.quiz.score_service score_service;
    int newdrag,olddrag;
