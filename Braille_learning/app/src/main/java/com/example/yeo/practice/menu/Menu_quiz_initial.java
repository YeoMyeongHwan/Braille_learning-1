...
public class Menu_quiz_initial extends FragmentActivity {
    ...
    com.example.yeo.practice.quiz.quiz_service quiz_service;
    quiz_score score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_quiz_initial);
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) { //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    ...
                    quiz_menu_service.menu_page= Menu_info.MENU_QUIZ_VOWEL;
