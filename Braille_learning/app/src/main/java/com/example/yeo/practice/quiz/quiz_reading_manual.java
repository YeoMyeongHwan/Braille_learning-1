...
import com.example.yeo.practice.Display_Practice.Quiz_Braille_reading_long_practice;
import com.example.yeo.practice.Display_Practice.Quiz_Braille_reading_short_practice;
            ...
            case MotionEvent.ACTION_UP: //손가락 1개가 화면에서 떨어졌을 때
                ...
                if(enter == true) {
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        ...
                        switch(choice) {
                            case 1: //초성퀴즈
                                Intent intent = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 1;
                                break;
                            case 2: //모음퀴즈
                                Intent intent2 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent2, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 2;
                                break;
                            case 3: //종성퀴즈
                                Intent intent3 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent3, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 3;
                                break;
                            case 4: //숫자퀴즈
                                Intent intent4 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent4, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 4;
                                break;
                            case 5: //알파벳 퀴즈
                                Intent intent5 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent5, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 5;
                                break;
                            case 6: //문장부호 퀴즈
                                Intent intent6 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent6, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 6;
                                break;
                            case 7: //약자 및 약어 퀴즈
                                Intent intent7 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent7, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 7;
                                break;
                            case 8: //글자 퀴즈
                                Intent intent8 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_short_practice.class);
                                startActivityForResult(intent8, ENTER);
                                quiz_service.question = 1;
                                WHclass.quiz_sel = 8;
                                break;
                            case 9: //단어퀴즈
                                Intent intent9 = new Intent(quiz_reading_manual.this, Quiz_Braille_reading_long_practice.class);
